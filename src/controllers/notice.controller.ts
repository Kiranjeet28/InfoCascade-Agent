 ...
 * =====================================================
 */
export const getAllNotices: RequestHandler<
    {},
    any,
    any,
    NoticeQuery
 ...
 * =====================================================
 */
export const getNoticeById: RequestHandler<
    NoticeParams
> = asyncHandler(async (req, res) => {
 ...
 * =====================================================
 */
export const updateNotice: RequestHandler<
    NoticeParams
> = asyncHandler(async (req, res) => {
 ...
 * =====================================================
 */
export const deleteNotice: RequestHandler<
    NoticeParams
> = asyncHandler(async (req, res) => {
 ...
 * =====================================================
 */
export const latestNotices: RequestHandler<
    {},
    any,
    any,
    NoticeQuery
