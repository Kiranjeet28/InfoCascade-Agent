...
import { authRateLimit, passwordChangeRateLimit, } from "../middleware/rateLimit.js";
 ...
 */
router.put("/change-password", auth, passwordChangeRateLimit, changePasswordValidator, validate, changePassword);
